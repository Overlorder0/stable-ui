    ...
    <div v-show="store.currentImageProps.sourceImage">
        <div class="canvas-container">
            ...
            <el-form label-width="110px" style="margin-top: 10px">
                <form-slider style="margin-bottom: 5px" label="Размер кисти" prop="brushSize" v-model="canvasStore.brushSize" :min="10" :max="100" :step="10" :change="canvasStore.setBrush" />
            </el-form>
        </div>
    </div>
</template>
